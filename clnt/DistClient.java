...
public class DistClient implements Watcher, AsyncCallback.StatCallback, AsyncCallback.DataCallback {
	...
	// , UnknownHostException
		...
		// TODO replace 24 with your group number.
		taskNodeName = zk.create("/dist24/tasks/task-", dTaskSerial, Ids.OPEN_ACL_UNSAFE,
				CreateMode.PERSISTENT_SEQUENTIAL);
		// taskNodeName = zk.create("/dist24/tasks/task-", pinfo.getBytes(),
	...
	public void processResult(int rc, String path, Object ctx, byte[] data, Stat stat) {
		...
		try {
			zk.delete(taskNodeName + "/result", -1);
			zk.delete(taskNodeName, -1);
		} catch (Exception e) {
			e.printStackTrace();
		}
