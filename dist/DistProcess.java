...
public class DistProcess implements Watcher, AsyncCallback.ChildrenCallback, AsyncCallback.StatCallback { // ,
	...
	public void processResult(int rc, String path, Object ctx, Stat stat) {
		...
		switch (Code.get(rc)) {
			...
			case NONODE:
				...
				// }
				synchronized (workers_status) {
					workers_status.put(tokens[3], true);
				}
				break;
	...
	public void processResult(int rc, String path, Object ctx, List<String> children) {
		...
		System.out.println("LOG : callback called by : " + pinfo + "; " + "Path: " + path);
